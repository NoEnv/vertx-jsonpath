...
image:https://codecov.io/gh/NoEnv/vertx-jsonpath/branch/master/graph/badge.svg["Code Coverage",link="https://codecov.io/gh/NoEnv/vertx-jsonpath"]
...
----
compile 'com.noenv:vertx-jsonpath:3.9.13'
----
